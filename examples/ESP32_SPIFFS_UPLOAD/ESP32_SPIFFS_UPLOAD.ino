...
// UPLOAD SPIFFS via ESP32 SPIFFS Uploader.
// (Skip 1 and 2 if already esp32fs-plugin installed.)
// 1. Install https://github.com/me-no-dev/arduino-esp32fs-plugin/releases/
// 2. Restart Arduino IDE
// 3. Open this Sketch Again and connect your ESP32 to PC
